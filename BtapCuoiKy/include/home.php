<link href='https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.8/ScrollMagic.min.js' type='text/javascript'/>
<!-- top Products -->
		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				...
				<div class="col-lg-3 mt-lg-0 mt-4 p-lg-0">
					...
					<div class="side-bar p-sm-4 p-3"style="margin-top: 30px;width: 285px;height: 600px;position:fixed;top:10px">
						<div class="f-grid py-2 sidebar">
